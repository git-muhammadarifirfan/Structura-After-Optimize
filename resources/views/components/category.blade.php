        ...
        @foreach ($categories as $category)
            <a href="{{ route('byCategory', $category->slug) }}"
                ...
                <div
                    ...
                    <img src="{{ thumb_url($category->image, 160) }}" loading="lazy" decoding="async" fetchpriority="low"
                        sizes="64px" width="160" height="160" alt="{{ $category->category_name }}"
        ...
        @foreach ($categories->take(10) as $category)
            <a href="{{ route('byCategory', $category->slug) }}"
                ...
                <div class="h-full w-[80px] flex-shrink-0">
                    <img src="{{ thumb_url($category->image, 240) }}" loading="lazy" decoding="async" fetchpriority="low"
                        sizes="80px" width="240" height="240" alt="{{ $category->category_name }}"
